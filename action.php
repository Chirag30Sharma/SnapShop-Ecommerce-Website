...
<form action = 'https://www.sandbox.paypal.com/cgi-bin/webscr' method = 'post' >
  <input type='hidden' name='business' value='sb-qxlf722348413@business.example.com'>
  ...
  <input type='hidden' name='cmd' value='_cart'>"
      ...
      echo
        '<input type="hidden" name="return" value="http://localhost:3000/payment_success.php"/>
			<input type="hidden" name="notify_url" value="http://localhost:3000/payment_success.php">
			<input type="hidden" name="cancel_return" value="http://localhost:3000/cancel.php"/>
			<input type="hidden" name="currency_code" value="USD"/>
