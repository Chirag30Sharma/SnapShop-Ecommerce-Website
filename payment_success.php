...
$trx_id=$_GET['PayerID'];//transaction id returnerd by paypal
$cm_user_id = $_SESSION['userid'];
...
//  echo "everything is okey";
  ...
  if(mysqli_num_rows($result)>0){
       ...
       for($i=0;$i<count($product_id);$i++){
            ...
            VALUES ('$cm_user_id','".$product_id[$i]."','".$p_name[$i]."','".$p_price[$i]."','".$qty[$i]."','Completed','".$trx_id."')";
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" >
    <a class="navbar-brand" href="#" >CartAce</a>
